...
var axiosClient = axios_1["default"].create({
    paramsSerializer: function (params) { return query_string_1["default"].stringify(params); }
});
axiosClient.interceptors.request.use(function (config) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        config.headers = __assign({ Authorization: '', Accept: 'application/json' }, config.headers);
        config.data;
